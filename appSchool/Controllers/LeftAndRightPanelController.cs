...
namespace appSchool.Controllers
{
    ...
    public class LeftAndRightPanelController : Controller
    {
        ...
        public ActionResult ReturnLeftPanelView(int moduleID)
        {
            ...
            string  moduleName = unitOfWork.appModuleservices.GetAppModuleName(moduleID, byte.Parse(Session["CompID"].ToString()), byte.Parse(Session["BranchID"].ToString())).MenuText;
